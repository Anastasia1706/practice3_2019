...
my_data <- data.table(read.csv('C:/Users/Anastasia_/Documents/RStudio/dairy/comtrade(9).csv'
                               ))
...
work_data <- select(my_data, Period.Date, Trade.Flow, Reporter, Partner, Commodity,
                     Trade.Value..US..)
